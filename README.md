...
![IoT](https://placehold.co/200x80/000000/FFFFFF?text=IoT)
...
|------|------|------------------|-------------------|------|
| SaaS for BMS | SaaS | NextJS, AWS IoT Core | Modern saas solution for building management system | [GitHub]([https://github.com/deven-sitapara/#private-bms-repo](https://github.com/deven-sitapara/PropertyHub-OS) |
